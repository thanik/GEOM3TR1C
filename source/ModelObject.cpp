...
bool ModelObject::InitializeModel(ID3D11Device* device, char* filename)
{
	LoadModel(filename);
...
bool ModelObject::InitializeTeapot(ID3D11Device* device)
{
...
bool ModelObject::InitializeSphere(ID3D11Device* device)
{
...
bool ModelObject::InitializeBox(ID3D11Device* device, float xwidth, float yheight, float zdepth)
{
